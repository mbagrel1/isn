...
pygame.display.set_caption('deplacement_personnage')   #titre de la fenetre
...
# Boucle infinie
continuer = True
#--------------- repetition lors du maintien des touches-----------
	...
	for event in pygame.event.get():
		...
		if event.type==KEYDOWN:
			...
			if event.key==K_RIGHT:
				persorect=persorect.move(2,0)
#------------gestion de l'evolution (conditions pour rester dans la fenetre)----------------
#on utilise les attributs haut, bas , gauche et droite de l'objet Rect()
		if persorect.top<=0:
			persorect.top=0
